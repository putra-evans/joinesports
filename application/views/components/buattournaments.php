...
if (!isset($_SESSION['akun'])) {
    ...
    window.location='$tournament_jenis/tournaments';
  </script>");
}
    ...
    <div class="col-lg-12">
        <form class="form-horizontal" action="<?php echo site_url('buattournaments') ?>" method="post" enctype="multipart/form-data">
            <div class="form-group">
                ...
                <input class="form-control <?php echo form_error('tournament_jenis') ? 'is-invalid' : '' ?>" type="text" name="tournament_jenis" value="<?php echo $tournament_jenis ?>" readonly />
