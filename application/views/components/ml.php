<div class="container top-section" style=" margin-top: 120px">
    <div class=" d-flex flex-row mb-2 portal-nav">
        <img src="<?php echo base_url('frontend/img/games/ml.png') ?>" alt="" height="30px" class="mr-2 mb-3">
        ...
        <div class="portal-nav ml-auto">
            ...
            <a href="<?php echo base_url() ?>ml/team" class="mr-2">TEAMS</a>
    ...
    <div class="row">
        <div class="col-lg-6">
            <div class="card bg-dark text-white mb-3">
                <img src="<?php echo base_url('frontend/img/ml.jpg') ?>" class="card-img" style="width: 540px;height: 345px">
        ...
        <div class="col-lg-6">
            <div class="card bg-black mb-3">
                <div class="container">
                    ...
                    $ambil = $koneksi->query("SELECT * FROM tb_tournament  where tournament_status='mulai' AND tournament_jenis='ml' LIMIT 3");
                    //
                    while ($pecah = $ambil->fetch_object()) {
                    ?>
                        <a href="<?php echo site_url('ml/detailtournament/' . $pecah->tournament_id) ?>">
        ...
        <div class="card bg-black col-lg-12 mb-3">
                    ...
                    <div class="col-md-6">
                        ...
                        foreach ($bagan as $bagan) :
                            ...
                            if ($no <= 1) {
                                ...
                                if (($bagan->bagan_scorea == "") && ($jenistournament->tournament_jenis == 'ml')) {
                                    $no++;
                        ...
                        ?>
                                    <div class="card bg-dark text-white mb-3 game-card" style="background-image:url(<?php echo base_url('frontend/img/placeholder.jpg') ?>); background-size: 100% ;">
                                        <a href="<?php echo site_url('ml/detailtournament/' . $bagan->bagan_tournamentid) ?>">
                    ...
                    <div class="col-md-6">
                        ...
                        foreach ($bagans as $bagans) :
                            ...
                            if ($no <= 1) {
                                ...
                                $jenistournament = mysqli_fetch_object($jenis);
                                if (($bagans->bagan_scorea != "") && ($jenistournament->tournament_jenis == 'ml')) {
                                    $no++;
                        ...
                        ?>
                                    <div class="card bg-dark text-white mb-3 game-card" style="background-image:url(<?php echo base_url('frontend/img/placeholder.jpg') ?>); background-size: 100% ;">
                                        <a href="<?php echo site_url('ml/detailtournament/' . $bagans->bagan_tournamentid) ?>">
                                            <div class="card-img d-flex flex-column" style="margin-top:-15px;margin-left:0px;">
                                                <h5 class="card-title mt-auto" style="color:white;margin-left:5px"><?php echo $tima->tim_nama ?> VS <?php echo $timb->tim_nama ?></h5>
                                                <small style="text-align:right;margin-right:5px; color:white;"><?php echo $bagan->bagan_waktu ?></small>
                                            </div>
            ...
            <center>
                <a href="<?php echo base_url('ml/match') ?>" class=" btn btn-primary text-center mb-4 mt-4" style="width:300px; border-radius: 100px">SEE ALL MATCHES</a></center>
        </div>
        <div class="card bg-black col-lg-12 mb-5">
            <div class="container">
                <div class="row mt-4">
                    ...
                    <div class="col-md-6" id="hide">
                        ...
                        // $koneksi = mysqli_connect('localhost', 'joinesports_root', 'egova13081996', 'joinesports_database');
                        $koneksi = mysqli_connect('localhost', 'root', '', 'db_join');
                        $ambil = $koneksi->query("SELECT * FROM tb_tournament LEFT JOIN tb_achievement on tb_tournament.tournament_id=tb_achievement.achievement_idtournament where tournament_status='segera' AND tournament_jenis='ml' ORDER BY tournament_tglmulai DESC LIMIT 2");
                        while ($satu = $ambil->fetch_object()) {
                            if (($satu->tournament_status == 'segera') && ($satu->tournament_id != $satu->achievement_idtournament)) { ?>
                                <a href="<?php echo site_url('ml/detailtournament/' . $satu->tournament_id) ?>">
                                    <div class="card bg-dark text-white mb-3 game-card" style="background-image:url(<?php echo base_url('frontend/img/placeholder.jpg') ?>); background-size: 100% ;">
                                        <div class="card-img d-flex flex-column" style="margin-top:-15px;margin-left:0px;">
                    ...
                    <div class="col-md-6" id="hide1">
                        ...
                        // $koneksi = mysqli_connect('localhost', 'joinesports_root', 'egova13081996', 'joinesports_database');
                        $koneksi = mysqli_connect('localhost', 'root', '', 'db_join');
                        $ambil = $koneksi->query("SELECT * FROM tb_tournament LEFT JOIN tb_achievement on tb_tournament.tournament_id=tb_achievement.achievement_idtournament where tournament_status='selesai' AND tournament_jenis='ml'ORDER BY tournament_tglmulai ASC LIMIT 2");
                        while ($satu = $ambil->fetch_object()) {
            ...
            <center>
                <a href="<?php echo site_url('ml/tournaments') ?>" class=" btn btn-primary text-center mb-4 mt-4" style="width:300px; border-radius: 100px" id="btn">SEE ALL TOURNAMENTS</a>
                ...
                <div class="d-flex flex-column">
                    <table style="margin-left: 10px;margin-right: 10px">
                        ...
                        <tbody>
                            ...
                            // $koneksi = mysqli_connect('localhost', 'joinesports_root', 'egova13081996', 'joinesports_database');
                            $koneksi = mysqli_connect('localhost', 'root', '', 'db_join');
                            $ambil = $koneksi->query("SELECT * FROM tb_player LEFT JOIN  tb_registrasi ON tb_player.player_registrasi= tb_registrasi.registrasi_id where player_cek='yes' AND player_jenis='ml ' ORDER BY player_tglmasuk ASC LIMIT 3");
                            while ($pecah = $ambil->fetch_object()) {
                                $no++; ?>
                                <tr>
                                    ...
                                    <td style="color: #e0b403"><a href="<?php
                                                                        echo site_url('ml/detailplayer/' . $pecah->player_id) ?>"><?php echo $pecah->player_nickname ?>
                    ...
                    <a href="<?php echo base_url('ml/player') ?>" class="btn btn-primary font-weight-bold mt-4">SEE ALL PLAYERS</a>
                </div>
            </div>
        </div>
                ...
                <div class="d-flex flex-column">
                    <table style="margin-left: 20px">
                        ...
                        <tbody>
                            ...
                            // $koneksi = mysqli_connect('localhost', 'joinesports_root', 'egova13081996', 'joinesports_database');
                            $koneksi = mysqli_connect('localhost', 'root', '', 'db_join');
                            $ambil = $koneksi->query("SELECT * FROM tb_tim where tim_cek='yes' AND tim_jenis='ml' ORDER BY tim_tahunmasuk ASC LIMIT 3");
                            while ($pecah = $ambil->fetch_object()) {
                                $no++; ?>
                                <tr>
                                    ...
                                    <td style="text-align: right;color: #e0b403">
                                        <a href="<?php
                                                    echo site_url('ml/detailtim/' . $pecah->tim_id) ?>"><?php echo $pecah->tim_nama ?>
                                            <?php if ($pecah->tim_cek == 'yes') { ?>
                                                <img src="<?php echo base_url('frontend/img/centang.png') ?>" style="width: 14px"><?php  } ?></a></td>
                                </tr> <?php } ?>
                        </tbody>
                    </table>
                    <a href="<?php echo base_url('ml/team') ?>" class="btn btn-primary font-weight-bold mt-4">SEE ALL TEAMS</a>
                </div>
            </div>
        </div>
